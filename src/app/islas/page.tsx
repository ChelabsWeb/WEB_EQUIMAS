...
import { CaretRight, GridFour, ArrowRight } from '@phosphor-icons/react/dist/ssr';
            ...
            <main className="flex-grow pt-32">
                <section className="bg-white py-20">
                    <div className="container mx-auto px-6">
                        ...
                        <div className="mt-20 glass rounded-md p-12 overflow-hidden relative border border-primary/10">
                            <div className="flex items-center gap-6 mb-8">
                                <div className="p-4 bg-primary/10 rounded-md text-primary">
                                    <GridFour weight="bold" size={32} />
                                </div>
