...
import { CaretRight, Sparkle, User, Palette, Stack } from '@phosphor-icons/react/dist/ssr';
                    ...
                    <div className="container mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20">
                            <div className="glass p-8 rounded-md">
                                <User weight="bold" className="text-primary mb-4" size={32} />
                            ...
                            <div className="glass p-8 rounded-md">
                                <Palette weight="bold" className="text-primary mb-4" size={32} />
                            ...
                            <div className="glass p-8 rounded-md">
                                <Stack weight="bold" className="text-primary mb-4" size={32} />
                        ...
                        <div className="mt-20 glass rounded-md p-12 text-center overflow-hidden relative border-primary/10">
                            <div className="absolute top-0 right-0 p-10 opacity-10 rotate-12">
                                <Sparkle weight="fill" size={120} className="text-primary" />
                            </div>
