                        ...
                        <div className="bg-apple-bg/50 rounded-md p-12 overflow-hidden relative border border-primary/5">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                                <div>
                                    ...
                                    <Button asChild size="lg" className="group rounded-md bg-primary px-8 py-8 text-lg font-bold text-white transition-all hover:bg-black">
                                        <Link href="/contacto">
                                            Proyectar mi Espacio
                                            <ArrowRight weight="bold" size={20} className="ml-2 transition-transform group-hover:translate-x-1" />
                                        </Link>
                                    </Button>
                                </div>
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="relative h-64 overflow-hidden rounded-md shadow-lg translate-y-8">
                                        <Image
