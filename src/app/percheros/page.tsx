...
import { CaretRight, Ruler, ArrowRight } from '@phosphor-icons/react/dist/ssr';
            ...
            <main className="flex-grow pt-32">
                <section className="bg-white py-20">
                    <div className="container mx-auto px-6">
                        ...
                        <div className="mt-20 glass rounded-md p-12 border border-primary/10">
                            <div className="flex items-center gap-6 mb-8">
                                <div className="p-4 bg-primary/10 rounded-md text-primary">
                                    <Ruler weight="bold" size={32} />
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                ...
                                <div className="relative h-96 rounded-md overflow-hidden shadow-2xl">
                                    <Image
                        ...
                        <div className="mt-20 text-center">
                            <Button asChild size="lg" className="group rounded-md bg-primary px-10 py-8 text-xl font-bold text-white transition-all hover:bg-black">
                                <Link href="/contacto">
                                    ...
                                    <ArrowRight weight="bold" size={24} className="ml-2 transition-transform group-hover:translate-x-1" />
                                </Link>
                            </Button>
                        </div>
                    </div>
