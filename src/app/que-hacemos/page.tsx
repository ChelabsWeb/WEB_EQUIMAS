...
import { Target, Users, Lightning, ShieldCheck } from '@phosphor-icons/react';
                    ...
                    <div className="container mx-auto px-6">
                        <div className="features-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            {[
                                ...
                                <div key={i} className="feature-card rounded-md bg-surface p-8 shadow-sm hover:shadow-apple transition-shadow">
                ...
                <section className="bg-white py-24">
                    <div className="container mx-auto px-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                            <div className="relative h-[400px] md:h-[600px] overflow-hidden rounded-md shadow-2xl group">
                                <Image
