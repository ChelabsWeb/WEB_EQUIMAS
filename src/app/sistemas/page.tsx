...
import { CaretRight, Stack, ArrowRight } from '@phosphor-icons/react';
            ...
            <main className="flex-grow pt-32">
                ...
                <section className="bg-primary py-24 text-white overflow-hidden relative">
                    ...
                    <div className="container mx-auto px-6 text-center relative z-10">
                        ...
                        <div className="mt-12">
                            <Button asChild size="lg" className="rounded-md bg-white px-10 py-8 text-lg font-bold text-primary transition-all hover:bg-black hover:text-white hover:scale-105 shadow-xl">
                                <Link href="/contacto">
