...
import { FacebookLogo, InstagramLogo, LinkedinLogo, EnvelopeSimple, Phone, MapPin } from '@phosphor-icons/react';
                    ...
                    <div className="space-y-4">
                        <Link href="/" className="inline-block relative">
                            <Image
                                ...
                                width={120}
                                height={30}
                                className="h-8 w-auto opacity-80 hover:opacity-100 transition-all duration-500 dark:invert"
                            />
                        </Link>
                        ...
                        <div className="flex gap-4">
                            <Link
                                ...
                                className="p-2 rounded-md border border-transparent hover:border-border hover:bg-apple-bg transition-all active:scale-[0.9]"
